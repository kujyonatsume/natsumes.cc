    ...
    <v-app>
      ...
      <v-navigation-drawer v-model="drawer" expand-on-hover>
        <v-list nav density="comfortable">
          ...
          <v-list-item to="/about" prepend-icon="mdi-account" title="關於我" />
          <v-list-item to="/links" prepend-icon="mdi-account" title="我的相關連結" />
      ...
      <!-- Footer -->
      <v-footer app class="justify-center py-4 text-sm text-neutral-700 dark:text-neutral-300">
...
function setTheme (name: 'light' | 'dark') {
  ...
  if (process.client) {
    ...
    if (meta) meta.setAttribute('content', name === 'dark' ? '#101b39' : site.theme_color)
